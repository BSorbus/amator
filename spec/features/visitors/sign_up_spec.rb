...
feature 'Sign Up', :devise do
  ...
  scenario '5. visitor cannot sign up with a short password' do
  ...
  scenario '6. visitor cannot sign up without password confirmation' do
  ...
  scenario '7. visitor cannot sign up with mismatched password and confirmation' do
